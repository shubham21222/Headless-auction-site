...
export default function AuctionSectionWithCountry({ country }) {
  return (
    <div className="bg-gradient-to-b container mx-auto max-w-screen-2xl from-gray-50 to-white text-gray-900 py-16 px-4 sm:px-8 md:px-20 lg:px-32">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="space-y-4 sm:space-y-6">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-amber-600 to-amber-800">
            Discover Exclusive Auctions in {country} - Where Luxury Meets Opportunity
          </h1>
          <p className="text-base sm:text-lg text-gray-700">
            Step into a world of premium auctions in {country} where exceptional items find their perfect match. From rare collectibles to luxury items, every auction tells a unique story of value and prestige.
          </p>
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="relative rounded-xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
            <Image
              src="https://p1.liveauctioneers.com/6177/355085/194037707_1_x.jpg?height=300&quality=70&version=1733782984"
              alt="Featured auction item in {country}"
              layout="responsive"
              width={600}
              height={400}
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 sm:p-6">
              <div className="text-white">
                ...
                <h3 className="text-lg sm:text-xl font-bold">Vintage Collector{''}s Edition in {country}</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mt-12 sm:mt-16 space-y-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">
          Why Choose Our Auction Platform in {country}?
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Curated collection of authentic items in {country}, verified by experts for quality assurance.
            </p>
          </div>
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Experience the thrill of real-time auctions with instant bid updates and notifications in {country}.
            </p>
          </div>
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Advanced security measures ensuring safe transactions and user privacy protection in {country}.
            </p>
          </div>
        </div>
      </div>
